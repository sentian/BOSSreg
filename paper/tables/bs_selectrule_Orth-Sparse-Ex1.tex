...
\begin{table}[ht]
\centering
\caption{Information criteria for BS under orthogonal $X$. The true model setup is Orth-Sparse-Ex1 (see Supplemental Material Section \ref{sec:simulation_setup_orthx} for details). 
