...
## Compare information criteria using edf and hdf, respectively
...
### Figure 1: RMSE along the solution paths of BS, FS and BOSS --------
...
### Results to be used to produce Figure 2 & S1 --------
## Calculate Cp and AICc values for BOSS fits on replications of data under various true models
...
result_fig2s1 = cp.aicc.boss()

### Figure 2: Cp-edf and Cp-hdf for BOSS --------
plot.ic(result__fig2s1, ic = 'aicc', filename = 'aicc_edf_hdf_kl_boss.eps', ignore.edf=TRUE)

### Figure S1: Cp-edf and Cp-hdf for BOSS --------
plot.ic(result__fig2s1, filename = 'cp_edf_hdf_boss.eps')

### Results to be used to produce Figure 3-5 --------
## Calculate Cp, AICc and KL values for BS fits on replications of data under various true models
...
result_fig345 = df.cp.aicc.bs()

### Figure 3: hdf(k) and edf(k) for BS --------
...
### Figure 4: Cp-edf and Cp-hdf for BS --------
plot.ic(result_fig123, filename = 'cp_edf_hdf_bs.eps')

### Figure 5: AICc-edf and AICc-hdf for BS --------
plot.ic(result_fig123, ic = 'aicc', filename = 'aicc_edf_hdf_kl_bs.eps')

### Figure S2: Frequency distributions of the selected subset size for BS and LBS --------
