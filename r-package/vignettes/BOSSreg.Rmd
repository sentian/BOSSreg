...
references:
  - id: Tian2019
    ...
    - family: Simonoff
      given: Jeffrey S.
    URL: 'https://github.com/sentian/BOSSreg/blob/master/paper/boss.pdf'
    issued:
      year: 2019
---
...
```{r, cache=TRUE, fig.width=3, fig.height=3, fig.show='hold'}
...
saveRDS(result, '/Volumes/HDD/Dropbox/Sen/Research/Model_selection/rpackage/BOSSreg/r-package/vignettes/realdata.rds')
```
